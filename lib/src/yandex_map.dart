  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.android) {
      ...
      if(widget.mapObjectsWeb.isNotEmpty){
        ...
        for (var element in widget.mapObjectsWeb) { arrayWeb = '$arrayWeb {"type": "Feature", "id": 8, "geometry": {"type": "Point", "coordinates": [${element['latitude']}, ${element['longitude']}]}, "properties": {"balloonContentHeader": "", "balloonContentBody": ""}},'; }
      } else {
